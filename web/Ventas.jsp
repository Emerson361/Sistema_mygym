                ...
                <div class="card-body">
                        ...
                        <form action="Controlador?menu=Ventas" method="POST">
                            <div class="form-group">
                                ...
                                <select name="txtIdCliente" class="form-control" required>
                                    <c:forEach var="cliente" items="${clientes}">
                                        <option value="${cliente.getId()}" ${cliente.getId() == venta.getId_cliente() ? 'selected' : ''}>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" value="${venta.getFecha_recibo()}" name="txtFechaVenta" class="form-control" required>
                            </div>

                            <div class="form-group">
                                <label>Observación:</label>
                                <input type="text" value="${venta.getObservaciones()}" name="txtObservacion" class="form-control" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="txtIdMembresia" class="form-control" required>
                                    <c:forEach var="membresia" items="${membresias}">
                                        <option value="${membresia.getId()}" ${membresia.getId() == venta.getId_membresia() ? 'selected' : ''}>
                            ...
                            <div class="form-group">
                                ...
                                <select name="txtIdDieta" class="form-control">
                                    <c:forEach var="dieta" items="${dietas}">
                                        <option value="${dieta.getIdDieta()}" ${dieta.getIdDieta() == venta.getId_dieta() ? 'selected' : ''}>
                                            ${dieta.getNombre()}
                                        </option>
                                    </c:forEach>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="txtIdRutina" class="form-control" required>
                                    <c:forEach var="rutina" items="${rutinas}">
                                        <option value="${rutina.getId()}" ${rutina.getId() == venta.getId_rutina() ? 'selected' : ''}>
                                            ${rutina.getNombre()}
                                        </option>
                                    </c:forEach>
                                </select>
                ...
                <table class="table table-hover">
                    ...
                    <tbody id="TablaVenta">
                        <c:forEach var="venta" items="${ventas}">
                            <tr>
                                <td>${venta.getId_recibo()}</td>
                                <td>${venta.getCliente()}</td>
                                <td>${venta.getFecha_recibo()}</td>
                                <td>${venta.getObservaciones()}</td>
                                <td>${venta.getMembresia()}</td>
                                <td>${venta.getDieta()}</td>
                                <td>${venta.getRutina()}</td>
                                <td>
                                    <a class="btn btn-warning" href="Controlador?menu=Ventas&accion=Editar&id=${venta.getId_recibo()}">Editar</a>
                                    <a class="btn btn-danger" href="Controlador?menu=Ventas&accion=Eliminar&id=${venta.getId_recibo()}">Eliminar</a>
                                </td>                       
                            </tr>
                        </c:forEach>
